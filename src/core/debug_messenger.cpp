...
namespace Salamander::Core {
    ...
    void DebugMessenger::beginCmdDebugLabel(VkCommandBuffer commandBuffer, const char *labelName,
    ...
    void DebugMessenger::insertCmdDebugLabel(VkCommandBuffer commandBuffer, const char *labelName,
                                             const float color[4]) const {

...
namespace Salamander::Graphics {
    ...
    public:
        ...
        static void transitionColorAttachment(VkCommandBuffer cmd, VkImage image, VkImageLayout oldLayout,
                                              VkImageLayout newLayout)
        {
            VkImageMemoryBarrier2 barrier{
        ...
        static void transitionToPresent(VkCommandBuffer cmd, VkImage image, VkImageLayout oldLayout,
                                        VkImageLayout newLayout)
        {
            VkImageMemoryBarrier2 barrier{
                .sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2,

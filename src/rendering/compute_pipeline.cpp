...
ComputePipeline::ComputePipeline(Context* context,
    ...
    const ComputePipelineConfig& config, VkPushConstantRange pushConstantRange) : m_context(context),
    ...
    DeletionQueue::get().pushFunction("ComputePipeline" + std::to_string(pipelineID++), [deviceCopy, pipelineCopy]() {
...
void ComputePipeline::createPipelineLayout(VkDescriptorSetLayout computePipelineLayout, VkPushConstantRange pushConstantRange) {
    ...
    DeletionQueue::get().pushFunction("ComputePipelineLayout_" + std::to_string(pipelineLayoutID++), [deviceCopy, layoutCopy]() {
